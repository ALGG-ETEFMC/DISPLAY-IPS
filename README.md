...
<ul>
<li>1-Faça o download da pasta com os arquivos .c e .h que serão utilizados</li>
<li>2-Crie um projeto normalmente no STMCube IDE</li>
<li>3-Na configuração do MX, você pode configurar os leds e botões da placa:
...
<li>5-Ainda na configuração do MX, é necessário configurar a SPI1 para comunicar com o display. Para isso, vá
